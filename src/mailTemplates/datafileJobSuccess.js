...
let getUrls = (job) => {
  ...
  if (job.type === 'createDatafile') return { api: ihm + `?millesime=${ job.data.millesimeDatafile }`, csv: csv + `millesime=${ job.data.millesimeDatafile }&withColumnName=true&withColumnDescription=true&withColumnUnit=true`}
  if (job.type === 'addDatafileMillesime') return { api: ihm + `?millesime=${ job.data.millesimeDatafile }`, csv: csv + `millesime=${ job.data.millesimeDatafile }&withColumnName=true&withColumnDescription=true&withColumnUnit=true` }
  if (job.type === 'replaceDatafileMillesime') return { api: ihm + `?millesime=${ job.data.millesimeDatafile }`,csv: csv + `millesime=${ job.data.millesimeDatafile }&withColumnName=true&withColumnDescription=true&withColumnUnit=true`}
}
